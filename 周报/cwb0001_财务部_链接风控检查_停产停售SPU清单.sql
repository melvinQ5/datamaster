/*
 快百货在线SPU 多于系统非停产SPU原因数据分析
 */
-- 大数据产品表非停产非停售SPU清单
-- select count(distinct spu ) 
-- 	from erp_product_products epp where ismatrix = 1
-- 		and date_add(DevelopLastAuditTime,interval - 8 hour) >= '2017-07-01' 
-- 		and date_add(DevelopLastAuditTime,interval - 8 hour)  < '2023-08-01'
-- 		and ProjectTeam='快百货' 
-- 		and status = 10 
-- 		and  ProductStatus !=2 and  ProductStatus !=3
