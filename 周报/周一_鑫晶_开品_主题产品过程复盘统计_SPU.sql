...
from (
	select spu 
	,sum(KBH累计销量) as KBH累计销量
	,sum(KBH累计销售额 ) as KBH累计销售额 
	,sum(KBH销量2201) as KBH销量2201
	,sum(KBH销量2202) as KBH销量2202
	,sum(KBH销量2203) as KBH销量2203
	,sum(KBH销量2204) as KBH销量2204
	,sum(KBH销量2205) as KBH销量2205
	,sum(KBH销量2206) as KBH销量2206
	,sum(KBH销量2207) as KBH销量2207
	,sum(KBH销量2208) as KBH销量2208
	,sum(KBH销量2209) as KBH销量2209
	,sum(KBH销量2210) as KBH销量2210
	,sum(KBH销量2211) as KBH销量2211
	,sum(KBH销量2212) as KBH销量2212
	,sum(KBH销量2301) as KBH销量2301
	,sum(KBH销量2302) as KBH销量2302
	,sum(KBH销量2303) as KBH销量2303
	,sum(KBH销量2304) as KBH销量2304
	,sum(KBH销量2305) as KBH销量2305
	,sum(KBH销量2306) as KBH销量2306
	,sum(KBH销量2307) as KBH销量2307
	,sum(KBH销量2308) as KBH销量2308
	,sum(KBH销量2309) as KBH销量2309
	,sum(KBH销量2310) as KBH销量2310
	,sum(KBH销量2311) as KBH销量2311
	,sum(KBH销量2312) as KBH销量2312

	,sum(KBH销售额2201) as KBH销售额2201
	,sum(KBH销售额2202) as KBH销售额2202
	,sum(KBH销售额2203) as KBH销售额2203
	,sum(KBH销售额2204) as KBH销售额2204
	,sum(KBH销售额2205) as KBH销售额2205
	,sum(KBH销售额2206) as KBH销售额2206
	,sum(KBH销售额2207) as KBH销售额2207
	,sum(KBH销售额2208) as KBH销售额2208
	,sum(KBH销售额2209) as KBH销售额2209
	,sum(KBH销售额2210) as KBH销售额2210
	,sum(KBH销售额2211) as KBH销售额2211
	,sum(KBH销售额2212) as KBH销售额2212
	,sum(KBH销售额2301) as KBH销售额2301
	,sum(KBH销售额2302) as KBH销售额2302
	,sum(KBH销售额2303) as KBH销售额2303
	,sum(KBH销售额2304) as KBH销售额2304
	,sum(KBH销售额2305) as KBH销售额2305
	,sum(KBH销售额2306) as KBH销售额2306
	,sum(KBH销售额2307) as KBH销售额2307
	,sum(KBH销售额2308) as KBH销售额2308
	,sum(KBH销售额2309) as KBH销售额2309
	,sum(KBH销售额2310) as KBH销售额2310
	,sum(KBH销售额2311) as KBH销售额2311
	,sum(KBH销售额2312) as KBH销售额2312
...
left join (
	select spu ,ProductStatus ,ProductName ,date_add(DevelopLastAuditTime , interval - 8 hour)  DevelopLastAuditTime
		,date(date_add(DevelopLastAuditTime , interval - 8 hour))   `终审日期`
		,year(date_add(DevelopLastAuditTime , interval - 8 hour))   `终审年份`	
