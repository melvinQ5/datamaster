...
select asa.GenerateDate, asa.ShopCode ,asa.Asin , asa.AdClicks as Clicks, asa.AdExposure as Exposure, asa.AdSales as TotalSale7DayUnit, t.SPU, t.SKU, t.BoxSku ,ms.Site
	...
	, case when 0 < timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) and timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) <= 7*86400 then '是' else '否' end `是否7天`
	, case when 0 < timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) and timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) <= 14 then '是' else '否' end `是否14天`
	, case when 0 < timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) and timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) <= 30 then '是' else '否' end `是否30天`
	, case when 0 < timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) and timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) <= 60 then '是' else '否' end `是否60天`
	, case when 0 < timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) and timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) <= 90 then '是' else '否' end `是否90天`
	, case when 0 < timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) and timestampdiff(SECOND,t.DevelopLastAuditTime,asa.GenerateDate) <= 120 then '是' else '否' end `是否120天`
...
where eaal.ListingStatus = 1  and asa.GenerateDate >= '2023-03-20'
)
