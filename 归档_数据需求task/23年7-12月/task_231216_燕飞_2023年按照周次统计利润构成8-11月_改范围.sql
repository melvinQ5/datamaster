...
join mysql_store s on s.code =al.shopcode and s.Department='快百货' and s.nodepathname regexp '${team1}|${team2}'
and LastModificationTime>='2023-08-01' and LastModificationTime<'2023-12-01'
where al.sku <>''
)b where sort=1
)c 
)d where sort=1
...
where Year='2023' and week>=32 and week<=49
)a 
...
and department='快百货'
and paytime>='2023-08-01' and paytime<'2023-12-01' 
and orderstatus<>'作废'
