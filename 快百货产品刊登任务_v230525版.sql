...
/*
 老品必刊 数据实现方案：
01 计算老品必刊池， 目前符合条件的有1.5w个SKU
	老品当前在线账号数小于3的SKU
	剔除近1周有分配日志

02 生成刊登白名单表 (SKU X 未在线店铺 X 未在线店铺对应首选业务员)
	黑名单
	SKU 已刊登店铺 所属首选业务员
	001 AA-US 张三  
	002 AA-UK 李四
	------------------
	白名单
	SKU 所属1级类目 所属1级类目店铺 近3月业绩降序排名 首选业务员
	001 家居生活 BB-US 01 周六
	001 家居生活 CC-US 02 赵七
	...
	001 家居生活 DD-US 10 朱八

03 根据人员轮询表numbered_persons，结合分配日志，找到今日需分配人员
SPU SKU spu包编号 
001 001.01 1
001 002.01 1
002 002.01 2

04 从白名单中为每个人找出30个SPU

02 确定今日分配SKU
获取mysql_store成都销售团队所有人员
剔除上一步骤“新品必刊”任务已分配人员，10-2=8人
按30个SPU/人 x 8（剩余可分配人员） = 240个SPU （1个SPU每次分配任务只补到1套账号）
