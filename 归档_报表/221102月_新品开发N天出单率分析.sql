...
--where epp.DevelopLastAuditTime >= '2022-05-01' 
...
select * from (
	select '日期' `分析维度`, dev_month `开发月`, newpath1 `新类目`, DevelopUserName `开发人员`, SkuSource_cn `开发来源`, dev_cnt `开发sku数`, round(ord7_sku_cnt/dev_cnt,4) as d7_rate, round(ord14_sku_cnt/dev_cnt,4) as d14_rate, round(ord30_sku_cnt/dev_cnt,4) as d30_rate
	...
	from ( 
		select t.dev_month, '全类目' newpath1, '开发合计' as DevelopUserName, '来源合计' as SkuSource_cn
	...
	union all 
	select '日期/类目'  `分析维度`, dev_month `开发月`, newpath1 `新类目`, DevelopUserName `开发人员`, SkuSource_cn `开发来源`, dev_cnt `开发sku数`, round(ord7_sku_cnt/dev_cnt,4) as d7_rate, round(ord14_sku_cnt/dev_cnt,4) as d14_rate, round(ord30_sku_cnt/dev_cnt,4) as d30_rate
		, round(ord60_sku_cnt/dev_cnt,4) as d60_rate, round(ord90_sku_cnt/dev_cnt,4) as d90_rate, round(ord120_sku_cnt/dev_cnt,4) as d120_rate, ord7_sku_sales, ord14_sku_sales, ord30_sku_sales, ord60_sku_sales, ord90_sku_sales, ord120_sku_sales
	from ( select t.dev_month, t.newpath1, '开发合计' as DevelopUserName, '来源合计' as SkuSource_cn
			, count(distinct t.BoxSKU) as dev_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -7 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 7  then od.BoxSKU end) as ord7_sku_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -14 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days  <= 14 then od.BoxSKU end) as ord14_sku_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -30 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days  <= 30 then od.BoxSKU end) as ord30_sku_cnt
			...
			, round(sum(case when datediff(DATE_ADD(CURRENT_DATE(), interval -90 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 90 then AfterTax_TotalGross end)) as ord90_sku_sales
			, round(sum(case when datediff(DATE_ADD(CURRENT_DATE(), interval -120 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 120 then AfterTax_TotalGross end)) as ord120_sku_sales
		from tmp_epp t left join orders od on od.BoxSku =t.BoxSKU group by t.dev_month, t.newpath1
		) tmp
	
	union all 
	select '日期/开发人员'  `分析维度`, dev_month `开发月`, newpath1 `新类目`, DevelopUserName `开发人员`, SkuSource_cn `开发来源`, dev_cnt `开发sku数`, round(ord7_sku_cnt/dev_cnt,4) as d7_rate, round(ord14_sku_cnt/dev_cnt,4) as d14_rate, round(ord30_sku_cnt/dev_cnt,4) as d30_rate
		, round(ord60_sku_cnt/dev_cnt,4) as d60_rate, round(ord90_sku_cnt/dev_cnt,4) as d90_rate, round(ord120_sku_cnt/dev_cnt,4) as d120_rate, ord7_sku_sales, ord14_sku_sales, ord30_sku_sales, ord60_sku_sales, ord90_sku_sales, ord120_sku_sales
	from ( select t.dev_month, '全类目' as newpath1, t.DevelopUserName, '来源合计' as SkuSource_cn
			, count(distinct t.BoxSKU) as dev_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -7 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 7  then od.BoxSKU end) as ord7_sku_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -14 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days  <= 14 then od.BoxSKU end) as ord14_sku_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -30 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days  <= 30 then od.BoxSKU end) as ord30_sku_cnt
			...
			, round(sum(case when datediff(DATE_ADD(CURRENT_DATE(), interval -90 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 90 then AfterTax_TotalGross end)) as ord90_sku_sales
			, round(sum(case when datediff(DATE_ADD(CURRENT_DATE(), interval -120 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 120 then AfterTax_TotalGross end)) as ord120_sku_sales
		from tmp_epp t left join orders od on od.BoxSku =t.BoxSKU group by t.dev_month, t.DevelopUserName
		) tmp
	union all 
	select '日期/开发来源'  `分析维度`, dev_month `开发月`, newpath1 `新类目`, DevelopUserName `开发人员`, SkuSource_cn `开发来源`, dev_cnt `开发sku数`, round(ord7_sku_cnt/dev_cnt,4) as d7_rate, round(ord14_sku_cnt/dev_cnt,4) as d14_rate, round(ord30_sku_cnt/dev_cnt,4) as d30_rate
		, round(ord60_sku_cnt/dev_cnt,4) as d60_rate, round(ord90_sku_cnt/dev_cnt,4) as d90_rate, round(ord120_sku_cnt/dev_cnt,4) as d120_rate, ord7_sku_sales, ord14_sku_sales, ord30_sku_sales, ord60_sku_sales, ord90_sku_sales, ord120_sku_sales
	from ( select t.dev_month, '全类目' as newpath1, '开发合计' DevelopUserName, t.SkuSource_cn
			, count(distinct t.BoxSKU) as dev_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -7 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 7  then od.BoxSKU end) as ord7_sku_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -14 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days  <= 14 then od.BoxSKU end) as ord14_sku_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -30 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days  <= 30 then od.BoxSKU end) as ord30_sku_cnt
			...
			, round(sum(case when datediff(DATE_ADD(CURRENT_DATE(), interval -90 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 90 then AfterTax_TotalGross end)) as ord90_sku_sales
			, round(sum(case when datediff(DATE_ADD(CURRENT_DATE(), interval -120 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 120 then AfterTax_TotalGross end)) as ord120_sku_sales
		from tmp_epp t left join orders od on od.BoxSku =t.BoxSKU group by t.dev_month, t.SkuSource_cn
		) tmp
	union all 
	select '日期/开发来源/类目'  `分析维度`, dev_month `开发月`, newpath1 `新类目`, DevelopUserName `开发人员`, SkuSource_cn `开发来源`, dev_cnt `开发sku数`, round(ord7_sku_cnt/dev_cnt,4) as d7_rate, round(ord14_sku_cnt/dev_cnt,4) as d14_rate, round(ord30_sku_cnt/dev_cnt,4) as d30_rate
		, round(ord60_sku_cnt/dev_cnt,4) as d60_rate, round(ord90_sku_cnt/dev_cnt,4) as d90_rate, round(ord120_sku_cnt/dev_cnt,4) as d120_rate, ord7_sku_sales, ord14_sku_sales, ord30_sku_sales, ord60_sku_sales, ord90_sku_sales, ord120_sku_sales
	from ( select t.dev_month, t.newpath1, '开发合计' DevelopUserName, t.SkuSource_cn
			, count(distinct t.BoxSKU) as dev_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -7 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 7  then od.BoxSKU end) as ord7_sku_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -14 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days  <= 14 then od.BoxSKU end) as ord14_sku_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -30 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days  <= 30 then od.BoxSKU end) as ord30_sku_cnt
			...
			, round(sum(case when datediff(DATE_ADD(CURRENT_DATE(), interval -90 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 90 then AfterTax_TotalGross end)) as ord90_sku_sales
			, round(sum(case when datediff(DATE_ADD(CURRENT_DATE(), interval -120 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 120 then AfterTax_TotalGross end)) as ord120_sku_sales
		from tmp_epp t left join orders od on od.BoxSku =t.BoxSKU group by t.dev_month, t.SkuSource_cn, t.newpath1
		) tmp
	union all 
	select '日期/开发人员/类目'  `分析维度`, dev_month `开发月`, newpath1 `新类目`, DevelopUserName `开发人员`, SkuSource_cn `开发来源`, dev_cnt `开发sku数`, round(ord7_sku_cnt/dev_cnt,4) as d7_rate, round(ord14_sku_cnt/dev_cnt,4) as d14_rate, round(ord30_sku_cnt/dev_cnt,4) as d30_rate
		, round(ord60_sku_cnt/dev_cnt,4) as d60_rate, round(ord90_sku_cnt/dev_cnt,4) as d90_rate, round(ord120_sku_cnt/dev_cnt,4) as d120_rate, ord7_sku_sales, ord14_sku_sales, ord30_sku_sales, ord60_sku_sales, ord90_sku_sales, ord120_sku_sales
	from ( select t.dev_month, t.newpath1, t.DevelopUserName, '来源合计' as SkuSource_cn
			, count(distinct t.BoxSKU) as dev_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -7 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 7  then od.BoxSKU end) as ord7_sku_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -14 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days  <= 14 then od.BoxSKU end) as ord14_sku_cnt
			, count(distinct case when datediff(DATE_ADD(CURRENT_DATE(), interval -30 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days  <= 30 then od.BoxSKU end) as ord30_sku_cnt
			...
			, round(sum(case when datediff(DATE_ADD(CURRENT_DATE(), interval -90 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 90 then AfterTax_TotalGross end)) as ord90_sku_sales
			, round(sum(case when datediff(DATE_ADD(CURRENT_DATE(), interval -120 day),t.DevelopLastAuditTime)>0 and 0 < ord_days and ord_days <= 120 then AfterTax_TotalGross end)) as ord120_sku_sales
		from tmp_epp t left join orders od on od.BoxSku =t.BoxSKU group by t.dev_month, t.DevelopUserName, t.newpath1
		) tmp
) union_tmp
order by  `分析维度`, `开发月`, `新类目`, `开发人员`, `开发来源`